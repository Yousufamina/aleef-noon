...
// UNUSED EXPORTS: A11y, Controller, EffectCreative, EffectCube, EffectFlip, FreeMode, Grid, HashNavigation, History, Keyboard, Manipulation, Parallax, Scrollbar, Thumbs, Virtual, Zoom
  ...
  const setTranslate = () => {
    ...
    for (let i = 0; i < slides.length; i += 1) {
      ...
      if (params.slideShadows) {
        ...
        let shadowEl = slideEl.querySelector('.swiper-slide-shadow');
        if (!shadowEl) {
          shadowEl = create_shadow_createShadow('cards', slideEl);
        }
